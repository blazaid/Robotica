...
- A través de bibliotecas como [numpy](https://numpy.org/) o [Pillow](https://pillow.readthedocs.io/en/stable/) se pueden realizar transformaciones en la composición de las imágenes.

- En el notebook *Imagen_Digital.ipynb* cubriremos el tratamiento básico de imagen con Python.
