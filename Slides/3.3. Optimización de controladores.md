...
_**Por refuerzo**: Se aprende a través de la experiencia a base de recompensas_
...
<div class="cite-author" data-text="Edward Thorndike - Law of Effect (1898)">
   ...
   «Las respuestas que producen un efecto positivo en una situación concreta aumuntan la probabilidad de repetirse en dicha situación, mientras que las que producen un efecto negativo la reducen.»
...
En general los comportamientos se aprenden mediante bucles observación-acción-recompensa
...
- ¿Cómo sabemos **qué acciones futuras son óptimas**? Spoiler: **No lo sabemos**
...
# Comparativa entre métodos directos e indirectos<!--fit-->
...
<video controls width=100% src="https://www.youtube.com/watch?v=gn4nRCC9TwQ"></video>

---

# Relevancia del aprendizaje por refuerzo<!--_class: transition--><!--fit-->
...
# Relevancia del aprendizaje por refuerzo hoy en día<!--fit-->
...
En la ética moral, una de las principales preguntas es: **¿qué debemos hacer?**
