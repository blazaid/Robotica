...
> <sup>3</sup> Disculpas por anticipado a todo estudiante de griego clásico. En realidad remplazó el sufijo <i>-tes</i> (actor, agente) por <i>-ike</i> (disciplina, práctica, actividad), pasando de <i>κυβερνήτης</i> (kybernetes) a <i>κυβερνητική</i> (kybernetike).
